...
bool initializeDatabase()
{
    const QStringList queries = QStringList()
        ...
        << "INSERT INTO book_views VALUES(1,1,1,'By Title',NULL,'SELECT DISTINCT file, title, author FROM books ORDER BY upper(title), title','/usr/share/explorer/images/middle/dictionary.png')"
        << "INSERT INTO book_views VALUES(2,2,1,'By Author',NULL,'SELECT DISTINCT author FROM books ORDER BY upper(author), author;SELECT DISTINCT file, title, author FROM books WHERE author = :author ORDER BY upper(title), title','/usr/share/explorer/images/middle/author.png')"
        << "INSERT INTO book_views VALUES(3,3,1,'By Publisher',NULL,'SELECT DISTINCT publisher FROM books ORDER BY upper(publisher), publisher;SELECT DISTINCT file, title, author FROM books WHERE publisher = :publisher ORDER BY upper(title), title','/usr/share/explorer/images/middle/publisher.png')"
        << "INSERT INTO book_views VALUES(4,4,1,'By Year',NULL,'SELECT DISTINCT year FROM books ORDER BY year;SELECT DISTINCT file, title, author FROM books WHERE year = :year ORDER BY upper(title), title','/usr/share/explorer/images/middle/calendar.png')"
        << "INSERT INTO book_views VALUES(5,5,1,'By Series',NULL,'SELECT DISTINCT series FROM books WHERE series <> '''' ORDER BY upper(series), series;SELECT DISTINCT file, title, author FROM books WHERE series = :series ORDER BY series_index','/usr/share/explorer/images/middle/series.png')"
        << "INSERT INTO book_views VALUES(6,6,1,'New',NULL,'SELECT DISTINCT file, title, author FROM books WHERE add_date > :week_ago ORDER BY add_date DESC, upper(title), title','/usr/share/explorer/images/middle/new.png')"
        << "INSERT INTO book_views VALUES(7,7,1,'Recently Read',NULL,'SELECT DISTINCT file, title, author FROM books WHERE read_date > :week_ago ORDER BY read_date DESC, upper(title), title','/usr/share/explorer/images/middle/book.png')"
